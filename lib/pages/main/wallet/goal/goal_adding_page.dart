...
class GoalAddingPage extends StatefulWidget {
  const GoalAddingPage({super.key});

  @override
  State<GoalAddingPage> createState() => _GoalAddingPageState();
}

class _GoalAddingPageState extends State<GoalAddingPage> with RestorationMixin {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 10,),
            Text("Add Goal",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),),
          ],
        ),
        leadingWidth: 0,
        toolbarHeight: 60,
                  ...
                  child: TextButton(
                    onPressed: () async {
                      ...
                      if (nameController.text.isEmpty) {
                        ...
                        await Utilities.createGoal(Goal(
                          id: const Uuid().v4(),
