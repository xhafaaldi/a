      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 10,),
            Expanded(child: Text("Debts",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),)),
            IconButton(
                      ...
                      return AlertDialog(
                        ...
                        actions: [
                          ElevatedButton(
                              onPressed: () async {
                                HapticFeedback.selectionClick();
                                await Utilities.removeDebt(debt);
                                if (context.mounted) {
                                  Navigator.pop(context);
                                  Navigator.pop(context);
                                }
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(
                            DateFormat("dd/MM/yyyy").format(debt.creationDate),
                          )
                        ],
                      ),
                      SizedBox(height: 10,),
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(
                            DateFormat("dd/MM/yyyy").format(debt.targetDate),
                          )
                        ],
                      ),
                      SizedBox(height: 10,),
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(
                            "${globals.currentAccount!.currency.symbol}${Utilities.formatNumber(debt.amount)}",
                          )
                        ],
                      ),
                    ],
