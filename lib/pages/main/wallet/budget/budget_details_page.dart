      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 10,),
            Expanded(child: Text("Budgets",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),)),
            IconButton(
                      ...
                      return AlertDialog(
                        ...
                        actions: [
                          ElevatedButton(
                              onPressed: () async {
                                HapticFeedback.selectionClick();
                                await Utilities.removeBudget(budget);
                                if (context.mounted) {
                                  Navigator.pop(context);
                                  Navigator.pop(context);
                                }
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text(
                                DateFormat("dd/MM/yyyy").format(budget.untilDate),
                              )
                            ],
                          ),
                          SizedBox(height: 10,),
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text(
                                "${globals.currentAccount!.currency.symbol}${Utilities.formatNumber(budget.amount)}",
                              )
                            ],
                          ),
                          SizedBox(height: 10,),
                          if (budget.recurring)
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text("Recurring Type:",
                                    style: TextStyle(fontWeight: FontWeight.bold)),
                                SizedBox(width: 10,),
                                Text(
                                  budget.recurringType.name.capitalizeFirst!,
                                )
                              ],
                            ),
                        ]
